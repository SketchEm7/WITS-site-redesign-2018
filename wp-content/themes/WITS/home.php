...
<div class="home">
	...
	<div class="col-md-3">
		...
		background-color: #3C323B;" class="panel-widget-style"
		onmouseover="this.style.background='#9E1B42';"
		onmouseout="this.style.background='#3C323B';">
			<center>
				<h2><font style="color:#fff;">Mid-Atlantic</font></h2>
				<p>
					Washington, DC
<br />March 23, 2018
				</p>
	...
	<div class="col-md-3">
		...
		<div style="padding: 50px; margin-top: -10px; color: rgb(255, 255, 255);
		background-color: #1D181C;" class="panel-widget-style"
		onmouseover="this.style.background='#9E1B42';"
		onmouseout="this.style.background='#1D181C';">
			<center>
				<h2><font style="color:#fff;">Northeast</font></h2>
				<p>
					Philadelphia
<br />April 13 & 14, 2018
				</p>
	...
	<div class="col-md-3">
		...
		<div style="padding: 50px; margin-top: -10px; color: rgb(255, 255, 255);
		background-color: #2A2329;" class="panel-widget-style"
		onmouseover="this.style.background='#9E1B42';"
		onmouseout="this.style.background='#2A2329';">
			<center>
				<h2><font style="color:#fff;">Midwest</font></h2>
				<p>
					Chicago
<br />May 19, 2018
				</p>
	...
	<div class="col-md-3">
		<a href="/all-2018-summits">
		<div style="padding: 50px; margin-top: -10px; color: rgb(255, 255, 255);
		background-color: #493D48;" class="panel-widget-style"
		onmouseover="this.style.background='#9E1B42';"
		onmouseout="this.style.background='#493D48';">
			<center>
				<h2><font style="color:#fff;">All 2018 Summits</font></h2>
<p style="color:#fff;">Find one near you!
<br>⟶</p>
...
<strong>2018 Call For Speakers Now Open!</strong>
<br />
<br /><a target="_blank" href="http://womenintechsummit.net/wits-2018-call-for-speaking-proposals/">
<div class="btn-primary">Call For Speakers</div>
</a>
<br />
<br />		<center><strong>Stay up-to-date with future events.</strong>
<br />
<br />
