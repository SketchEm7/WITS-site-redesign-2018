...
<?php get_header(); ?>
    ...
    url('/wp-content/uploads/2016/07/Screen-Shot-2016-07-19-at-3.09.44-PM.png')">
			<div class="landing-home">
				...
				<div class="col-md-12">
					<div class="box">
						<span class="desc">April 21 & 22, 2017</span>
						<?php
  ...
  <a href="/philly_speaker">
	...
	<a href="/philadelphia-sponsors-page">
		<div class="col-md-4 nopadding">
...
<span style="color:red; font-weight:bold;">NOTE:</span> <span>Tickets are only available for Saturday sessions. Friday Only and Combined (Friday & Saturday) tickets are <span style="color:red; font-weight:bold;">sold out.</span></span>
						<br />
&nbsp;
					</center>
				<script src='https://www.universe.com/embed.js'></script><iframe id="unii-embed-page" src="https://www.universe.com/embed/listings/584dd72589827c0042850a39" frameborder="0" scrolling="no"></iframe>
				</div>
			</div>
