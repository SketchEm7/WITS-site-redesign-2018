...
<section class="container">
  ...
  <center><h1>Boston Speakers</h1></center>
        ...
        <div class="row speaker">
          ...
          <div class="col-md-10 col-xs-9">
            <a href="<?php the_permalink() ?>">
              ...
              <div class="speaker-job-title"><?php the_field('boston_job_title'); ?></div>
              <?php
              $excerpt = get_the_excerpt();
              $permalink = get_permalink();
              $talks = get_field('boston_session_relationship');
                if ($talks): ?>
